...
const STARTER_PRESETS = [
  {
    title: "REST API & JSON Explorer",
    desc: "Node.js HTTP server with CRUD endpoints and web client",
    prompt: "Create a Node.js REST API with /api/tasks and /api/health endpoints plus an interactive tester UI",
    tag: "Microservice",
  },
  {
    title: "Obsidian Developer Portfolio",
    desc: "Dark-mode developer showcase with interactive widgets",
    prompt: "Build an aesthetic obsidian and ember portfolio landing page with case studies and dynamic counters",
    tag: "Full-Stack Web",
  },
  {
    title: "Live Node.js Runtime Starter",
    desc: "Minimal zero-config Node http engine with hot reloading",
    prompt: "Build a modern Node.js server with live browser execution and status dashboard",
    tag: "Starter",
  },
  {
    title: "Interactive Canvas Visualizer",
    desc: "HTML5 Canvas particle generator with interactive controls",
    prompt: "Build an interactive audio & particle visualizer with HTML5 canvas and customizable sliders",
    tag: "Creative",
  },
];
        ...
        <div style={styles.heroSection}>
          ...
          <div style={styles.titleGroup}>
            <div style={styles.brandTitleRow}>
              ...
              <h1 style={styles.heading}>Zephyr Code</h1>
            </div>
